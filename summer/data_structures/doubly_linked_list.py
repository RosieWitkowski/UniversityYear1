...
if __name__ == "__main__":
    class_scores = DoublyLinkedList()

    # Same test cases as base linked list code 
    ...
    # Unique to doubly linked 
    print("+== Doubly-linked testing ==+")
    class_scores.append(58)
    print(class_scores)
    print("Tail: ", class_scores.tail.value) # 58
    print("Previous: ", class_scores.tail.previous.value) # 32
